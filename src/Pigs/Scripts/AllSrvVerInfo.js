...
// Create the TCUtil object locally
var objUtil = new ActiveXObject("TCUtil");

// Use the specified machine name, if any
var strComputer;
if (WScript.Arguments.Count())
  strComputer = WScript.Arguments(0);

// Create the AllSrv.AdminSession object
var objSession = objUtil.CreateObject("AllSrv.AdminSession", strComputer);
var objVerInfo = objSession.Version;
